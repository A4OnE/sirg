...
const HappyCustomer = () => {
  ...
  mt-10
    ...
    ">
      ...
      <div className="container mx-auto px-4 lg:px-8 grid grid-cols-1 gap-0 m-10
      md:grid-cols-1
      ...
      ">
        ...
        items-center
        " >
          <img src={data[0].img} alt="" className="
          w-56 h-56
          rounded-full
          sm:w-7/12 sm:h-full
          md:w-8/12
        ...
        <div className="lg:col-span-2 lg:ml-28">
          ...
          <p className="h-fit w-full  object-cover tracking-wider italic mt-8
          md:w-full
